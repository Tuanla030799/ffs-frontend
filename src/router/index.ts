...
const routes: RouteRecordRaw[] = [
  { path: '/', component: PublicLayout, children: [
    ...
    { path: 'collections', name: 'collections', component: CollectionListPage, meta: { title: 'Bộ sưu tập' } },
    { path: 'collections/:slug', name: 'collection-detail', component: CollectionDetailPage, meta: { title: 'Chi tiết bộ sưu tập' } },
    { path: 'brands', name: 'brands', component: BrandListPage, meta: { title: 'Thương hiệu' } },
    { path: 'brands/:slug', name: 'brand-detail', component: BrandDetailPage, meta: { title: 'Chi tiết thương hiệu' } },
    { path: 'blogs', name: 'blogs', component: BlogListPage, meta: { title: 'Blog' } },
    { path: 'blogs/:slug', name: 'blog-detail', component: BlogDetailPage, meta: { title: 'Chi tiết blog' } },
  ] },
  ...
  { path: '/admin', component: AdminLayout, meta: { requiresAdmin: true }, children: [
    ...
    { path: 'products/create', name: 'admin-product-create', component: ProductAdminFormPage, meta: { title: 'Create product', description: 'Tạo product, images, variants, SKUs và Editor.js.' } },
    { path: 'products/:id/edit', name: 'admin-product-edit', component: ProductAdminFormPage, meta: { title: 'Edit product', description: 'Cập nhật product, images, variants, SKUs và Editor.js.' } },
    ...
    { path: 'brands', name: 'admin-brands', component: BrandAdminPage, meta: { title: 'Brands', description: 'Quản lý thương hiệu sản phẩm.' } },
    { path: 'collections', name: 'admin-collections', component: CollectionAdminPage, meta: { title: 'Collections', description: 'Quản lý bộ sưu tập sản phẩm.' } },
    { path: 'blogs', name: 'admin-blogs', component: BlogAdminPage, meta: { title: 'Blogs', description: 'Quản lý bài viết storefront.' } },
    { path: 'blogs/create', name: 'admin-blog-create', component: BlogAdminFormPage, meta: { title: 'Create blog', description: 'Tạo bài viết storefront.' } },
    { path: 'blogs/:id/edit', name: 'admin-blog-edit', component: BlogAdminFormPage, meta: { title: 'Edit blog', description: 'Cập nhật bài viết storefront.' } },
